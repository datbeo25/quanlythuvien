    ...
    public partial class Trasach : Form
    {
        ...
        private void btn_Timkiem_Click(object sender, EventArgs e)
        {
            if (txt_Timkiem.Text!="")
            {
                ...
                var searchResults = from phieumuon in db.Phieumuonsaches
                                    ...
                                    where (phieumuon.Trangthai==false &&( phieumuon.Maphieumuon== Convert.ToInt32(txt_Timkiem.Text) || (phieumuon.Mathedocgia == Convert.ToInt32(txt_Timkiem.Text) || (d1g.Tendocgia.Contains(txt_Timkiem.Text)))))
                                    select new
                                    {
        ...
        private void dataGridViewThongtinphieumuon_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (crr_row != null)
            {
                ...
                {
                    txt_Ngayhethan.Text = crr_row.Cells[3].Value.ToString();
                }
